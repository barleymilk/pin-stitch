...
async function seedUsersAndBodyProfiles() {
  await prisma.user.createMany({
    data: [
      { userId: 'user_customer_01', role: 'CUSTOMER', name: '김민서', email: 'minseo@example.com', createdAt: daysAgo(90) },
      { userId: 'user_customer_02', role: 'CUSTOMER', name: '이지윤', email: 'jiyoon@example.com', createdAt: daysAgo(80) },
      { userId: 'user_customer_03', role: 'CUSTOMER', name: '박서연', email: 'seoyeon@example.com', createdAt: daysAgo(70) },
      { userId: 'user_customer_04', role: 'CUSTOMER', name: '정하린', email: 'harin@example.com', createdAt: daysAgo(60) },
      { userId: 'user_customer_05', role: 'CUSTOMER', name: '최나은', email: 'naeun@example.com', createdAt: daysAgo(50) },
      { userId: 'user_seller_01', role: 'SELLER', name: '뮤게 스튜디오', email: 'seller@muguet.example.com', createdAt: daysAgo(120) },
      { userId: 'user_admin_01', role: 'ADMIN', name: 'PIN STITCH 운영자', email: 'admin@pinstitch.example.com', createdAt: daysAgo(180) },
    ],
  });
...
async function seedProducts() {
  ...
  await prisma.productVariant.createMany({
    data: [
      { variantId: 'var_jacket_beige_s', productId: 'prod_soft_line_jacket', sku: 'MGT-JK-BE-S', color: 'Beige', size: 'S', availableQuantity: 12 },
      { variantId: 'var_jacket_beige_m', productId: 'prod_soft_line_jacket', sku: 'MGT-JK-BE-M', color: 'Beige', size: 'M', availableQuantity: 8 },
      { variantId: 'var_jacket_black_m', productId: 'prod_soft_line_jacket', sku: 'MGT-JK-BK-M', color: 'Black', size: 'M', availableQuantity: 4 },
      { variantId: 'var_denim_blue_s', productId: 'prod_wave_denim', sku: 'SRN-DN-BL-S', color: 'Blue', size: 'S', availableQuantity: 7 },
      { variantId: 'var_denim_blue_m', productId: 'prod_wave_denim', sku: 'SRN-DN-BL-M', color: 'Blue', size: 'M', availableQuantity: 3 },
      { variantId: 'var_denim_blue_l', productId: 'prod_wave_denim', sku: 'SRN-DN-BL-L', color: 'Blue', size: 'L', availableQuantity: 0 },
      { variantId: 'var_knit_ivory_s', productId: 'prod_daily_knit', sku: 'MGT-KN-IV-S', color: 'Ivory', size: 'S', availableQuantity: 18 },
      { variantId: 'var_knit_ivory_m', productId: 'prod_daily_knit', sku: 'MGT-KN-IV-M', color: 'Ivory', size: 'M', availableQuantity: 15 },
      { variantId: 'var_knit_black_m', productId: 'prod_daily_knit', sku: 'MGT-KN-BK-M', color: 'Black', size: 'M', availableQuantity: 9 },
      { variantId: 'var_dress_navy_s', productId: 'prod_wrap_dress', sku: 'LNU-DR-NV-S', color: 'Navy', size: 'S', availableQuantity: 6 },
      { variantId: 'var_dress_navy_m', productId: 'prod_wrap_dress', sku: 'LNU-DR-NV-M', color: 'Navy', size: 'M', availableQuantity: 5 },
      { variantId: 'var_skirt_charcoal_m', productId: 'prod_tailored_skirt', sku: 'SRN-SK-CH-M', color: 'Charcoal', size: 'M', availableQuantity: 11 },
    ],
  });

  await prisma.sizeMeasurement.createMany({
    data: [
      { sizeMeasurementId: 'measure_jacket_s', productId: 'prod_soft_line_jacket', size: 'S', shoulderCm: 39, chestCm: 48, lengthCm: 66, sleeveCm: 58 },
      { sizeMeasurementId: 'measure_jacket_m', productId: 'prod_soft_line_jacket', size: 'M', shoulderCm: 40.5, chestCm: 50, lengthCm: 68, sleeveCm: 59 },
      { sizeMeasurementId: 'measure_denim_s', productId: 'prod_wave_denim', size: 'S', waistCm: 33, hipCm: 45, thighCm: 27, lengthCm: 100 },
      { sizeMeasurementId: 'measure_denim_m', productId: 'prod_wave_denim', size: 'M', waistCm: 35, hipCm: 47, thighCm: 28.5, lengthCm: 101 },
      { sizeMeasurementId: 'measure_denim_l', productId: 'prod_wave_denim', size: 'L', waistCm: 37, hipCm: 49, thighCm: 30, lengthCm: 102 },
      { sizeMeasurementId: 'measure_knit_s', productId: 'prod_daily_knit', size: 'S', shoulderCm: 34, chestCm: 38, lengthCm: 55, sleeveCm: 60 },
      { sizeMeasurementId: 'measure_knit_m', productId: 'prod_daily_knit', size: 'M', shoulderCm: 35.5, chestCm: 40, lengthCm: 57, sleeveCm: 61 },
      { sizeMeasurementId: 'measure_dress_s', productId: 'prod_wrap_dress', size: 'S', shoulderCm: 36, chestCm: 44, waistCm: 36, lengthCm: 112 },
      { sizeMeasurementId: 'measure_dress_m', productId: 'prod_wrap_dress', size: 'M', shoulderCm: 37.5, chestCm: 46, waistCm: 38, lengthCm: 114 },
      { sizeMeasurementId: 'measure_skirt_m', productId: 'prod_tailored_skirt', size: 'M', waistCm: 34, hipCm: 46, lengthCm: 78 },
    ],
  });
}
...
async function seedReviewsAndSummaries() {
  ...
  await prisma.reviewKeyword.createMany({
    data: [
      { reviewKeywordId: 'keyword_001', reviewId: 'review_001', sentiment: 'POSITIVE', keyword: '어깨선 부드러움' },
      { reviewKeywordId: 'keyword_002', reviewId: 'review_001', sentiment: 'POSITIVE', keyword: '출근룩' },
      { reviewKeywordId: 'keyword_003', reviewId: 'review_002', sentiment: 'NEGATIVE', keyword: '소매 김' },
      { reviewKeywordId: 'keyword_004', reviewId: 'review_003', sentiment: 'NEGATIVE', keyword: '품 타이트' },
      { reviewKeywordId: 'keyword_005', reviewId: 'review_004', sentiment: 'POSITIVE', keyword: '허리 들뜸 적음' },
      { reviewKeywordId: 'keyword_006', reviewId: 'review_005', sentiment: 'NEGATIVE', keyword: '밑위 높음' },
      { reviewKeywordId: 'keyword_007', reviewId: 'review_006', sentiment: 'NEGATIVE', keyword: '슬림핏' },
      { reviewKeywordId: 'keyword_008', reviewId: 'review_007', sentiment: 'POSITIVE', keyword: '허리 조절' },
      { reviewKeywordId: 'keyword_009', reviewId: 'review_008', sentiment: 'NEGATIVE', keyword: '골반 타이트' },
    ],
  });
    ...
    data: [
      {
        ...
        variantId: 'var_jacket_beige_s',
        bodyProfileId: 'body_customer_01',
        summary: '162cm 전후 웨이브 체형, 정핏 선호 고객은 S 사이즈가 어깨와 품 모두 안정적으로 맞는 편입니다.',
      ...
      },
      {
        ...
        variantId: 'var_denim_blue_m',
        bodyProfileId: 'body_customer_01',
        summary: '허리 들뜸을 민감하게 보는 고객에게 긍정 반응이 많고, 운동화 기준 기장이 안정적입니다.',
        matchedReviewCount: 2,
        generatedAt: daysAgo(1),
      },
      {
        ...
        variantId: 'var_knit_ivory_m',
        bodyProfileId: 'body_customer_02',
        summary: '슬림핏 선호 고객도 몸 라인 노출을 체감할 수 있어 편안함을 원하면 한 사이즈 업을 고려하세요.',
...
async function seedStoresAndCoupons() {
  await prisma.store.createMany({
    data: [
      { storeId: 'store_hongdae', name: 'PIN STITCH 홍대 쇼룸', address: '서울 마포구 와우산로 29길 12', lat: 37.555141, lng: 126.922996, isOpen: true },
      { storeId: 'store_seongsu', name: 'PIN STITCH 성수 픽업스토어', address: '서울 성동구 연무장길 45', lat: 37.544581, lng: 127.055961, isOpen: true },
      { storeId: 'store_gangnam', name: 'PIN STITCH 강남 스토어', address: '서울 강남구 테헤란로 152', lat: 37.500982, lng: 127.036522, isOpen: false },
    ],
  });

  await prisma.storeInventory.createMany({
    data: [
      { storeInventoryId: 'inv_hongdae_jacket_s', storeId: 'store_hongdae', productId: 'prod_soft_line_jacket', variantId: 'var_jacket_beige_s', quantity: 3, floor: '2F', zone: 'A', rack: 'A-03', updatedAt: now },
      { storeInventoryId: 'inv_hongdae_denim_m', storeId: 'store_hongdae', productId: 'prod_wave_denim', variantId: 'var_denim_blue_m', quantity: 1, floor: '2F', zone: 'B', rack: 'B-07', updatedAt: now },
      { storeInventoryId: 'inv_seongsu_knit_m', storeId: 'store_seongsu', productId: 'prod_daily_knit', variantId: 'var_knit_ivory_m', quantity: 5, floor: '1F', zone: 'C', rack: 'C-02', updatedAt: now },
      { storeInventoryId: 'inv_seongsu_dress_s', storeId: 'store_seongsu', productId: 'prod_wrap_dress', variantId: 'var_dress_navy_s', quantity: 2, floor: '1F', zone: 'D', rack: 'D-01', updatedAt: now },
      { storeInventoryId: 'inv_gangnam_skirt_m', storeId: 'store_gangnam', productId: 'prod_tailored_skirt', variantId: 'var_skirt_charcoal_m', quantity: 0, floor: '3F', zone: 'E', rack: 'E-04', updatedAt: daysAgo(2) },
    ],
  });
...
async function seedCartOrdersPaymentsAndShipments() {
  ...
  await prisma.orderLine.createMany({
    data: [
      { orderLineId: 'order_line_0001_01', orderId: 'order_20260526_0001', productId: 'prod_soft_line_jacket', variantId: 'var_jacket_beige_s', quantity: 1, unitPriceAmount: 129000, lineTotalAmount: 129000 },
      { orderLineId: 'order_line_0002_01', orderId: 'order_20260525_0002', productId: 'prod_wave_denim', variantId: 'var_denim_blue_m', quantity: 1, unitPriceAmount: 79000, lineTotalAmount: 79000 },
      { orderLineId: 'order_line_0003_01', orderId: 'order_20260524_0003', productId: 'prod_daily_knit', variantId: 'var_knit_ivory_m', quantity: 1, unitPriceAmount: 49000, lineTotalAmount: 49000 },
      { orderLineId: 'order_line_0004_01', orderId: 'order_20260522_0004', productId: 'prod_wrap_dress', variantId: 'var_dress_navy_s', quantity: 1, unitPriceAmount: 98000, lineTotalAmount: 98000 },
      { orderLineId: 'order_line_0005_01', orderId: 'order_20260520_0005', productId: 'prod_tailored_skirt', variantId: 'var_skirt_charcoal_m', quantity: 1, unitPriceAmount: 69000, lineTotalAmount: 69000 },
    ],
  });
    ...
    data: [
      {
        ...
        method: '카드',
        receiptUrl: 'https://dashboard.tosspayments.com/receipt/redirection?transactionId=tgen_20260526_0001',
      ...
      },
      {
        ...
        method: '간편결제',
        receiptUrl: 'https://dashboard.tosspayments.com/receipt/redirection?transactionId=tgen_20260525_0002',
      ...
      },
      {
        ...
        method: '카드',
        receiptUrl: 'https://dashboard.tosspayments.com/receipt/redirection?transactionId=tgen_20260522_0004',
      ...
      },
      {
        ...
        method: '카드',
        receiptUrl: 'https://dashboard.tosspayments.com/receipt/redirection?transactionId=tgen_20260520_0005',
    ...
    data: [
      {
        ...
        severity: 'MEDIUM',
        message: '키 168cm 이상 고객 리뷰에서 소매 길이 언급이 반복됩니다. 소매 실측 강조가 필요합니다.',
        createdAt: daysAgo(1),
      },
      {
      ...
      },
      {
        ...
        severity: 'HIGH',
        message: '골반/허리 핏 반품 사유가 확인되어 L 사이즈 입고 또는 허리 실측 안내 보강이 필요합니다.',
        createdAt: daysAgo(0),
      },
    ],
  });
  ...
  await prisma.analyticsEvent.createMany({
    data: [
      ...
      },
      {
        ...
        orderId: 'order_20260522_0004',
        metadata: { shipmentId: 'shipment_0004', delayDays: 2, compensationCouponId: 'coupon_delay_3000' },
        createdAt: now,
      },
      {
